...
namespace WishList.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class Busy_obj1_Bindings :
            ...
            IBusy_Bindings
        {
            private global::WishList.Views.Busy dataRoot;
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::WishList.Views.Busy)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::WishList.Views.Busy obj, int phase)
            {
            ...
            private class Busy_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_IsBusy(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::WishList.Views.Busy obj = sender as global::WishList.Views.Busy;
                        if (obj != null)
                        {
                ...
                public void UpdateChildListeners_(global::WishList.Views.Busy obj)
                {
                    Busy_obj1_Bindings bindings;
                    if (WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::WishList.Views.Busy.IsBusyProperty, tokenDPC_IsBusy);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::WishList.Views.Busy.BusyTextProperty, tokenDPC_BusyText);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_IsBusy = obj.RegisterPropertyChangedCallback(global::WishList.Views.Busy.IsBusyProperty, DependencyPropertyChanged_IsBusy);
                            tokenDPC_BusyText = obj.RegisterPropertyChangedCallback(global::WishList.Views.Busy.BusyTextProperty, DependencyPropertyChanged_BusyText);
                        }
                    }
                }
            }
