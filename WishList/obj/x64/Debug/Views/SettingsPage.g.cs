#pragma checksum "D:\Toegepaste Informatica 3de jaar\Native Apps II - mobile apps Windows\Project - Wishlist\WishList\WishList\Views\SettingsPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "EF6AD2B2AEA916B8991DAF99BACC33CB"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace WishList.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::WishList.Views.SettingsPage dataRoot;
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::WishList.Views.SettingsPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::WishList.Views.SettingsPage obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_ViewModel(global::WishList.ViewModels.SettingsPageViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel_SettingsPartViewModel(global::WishList.ViewModels.SettingsPartViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 2:
                {
                    this.ViewModel = (global::WishList.ViewModels.SettingsPageViewModel)(target);
                }
                break;
            case 3:
                {
